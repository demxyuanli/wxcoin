...
public:
    void testNullPointerProtection() {
        ...
        std::cout << "  This would have caused a crash before the fix" << std::endl;
        std::cout << "  Now all methods check for null pointers first" << std::endl;
    ...
    void testMemorySafety() {
        ...
        std::cout << "✓ All methods check for null pointers" << std::endl;
        std::cout << "✓ No more access violations" << std::endl;
        std::cout << "✓ Safe to call methods after destruction" << std::endl;
        
        std::cout << "\nMemory safety improvements:" << std::endl;
        std::cout << "  - Destructor explicitly clears pointers" << std::endl;
        std::cout << "  - All access methods check for null pointers" << std::endl;
        std::cout << "  - Early return prevents further execution" << std::endl;
        std::cout << "  - No more 0xFFFFFFFFFFFFFFFF access violations" << std::endl;
    }

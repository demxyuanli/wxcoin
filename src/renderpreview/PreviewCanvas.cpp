...
PreviewCanvas::PreviewCanvas(wxWindow* parent, wxWindowID id, const wxPoint& pos, const wxSize& size)
	...
	, m_configGradientTopR(0.9)
	, m_configGradientTopG(0.95)
	, m_configGradientTopB(1.0)
	, m_configGradientBottomR(0.6)
	, m_configGradientBottomG(0.8)
	, m_configGradientBottomB(1.0)

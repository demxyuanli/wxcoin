...
EVT_BUTTON(ID_CREATE_TORUS, FlatFrame::onCommand)
	...
	EVT_BUTTON(ID_CREATE_NAV_CUBE, FlatFrame::onCommand)
...
EVT_BUTTON(ID_FACE_SELECTION_TOOL, FlatFrame::onCommand)
EVT_BUTTON(ID_EDGE_SELECTION_TOOL, FlatFrame::onCommand)
EVT_BUTTON(ID_VERTEX_SELECTION_TOOL, FlatFrame::onCommand)

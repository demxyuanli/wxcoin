...
void OCCTruncatedCylinder::buildShape()
{
    try {
        ...
        if (truncatedCylinderMaker.IsDone()) {
            m_shape = truncatedCylinderMaker.Shape();
            if (!m_shape.IsNull()) {

...
ThemeConfigEditor::ThemeConfigEditor(wxWindow* parent, UnifiedConfigManager* configManager, const std::string& categoryId)
...
void ThemeConfigEditor::createUI() {
    wxBoxSizer* mainSizer = new wxBoxSizer(wxVERTICAL);
    SetSizer(mainSizer);
}

void ThemeConfigEditor::loadConfig() {
...
void ThemeConfigEditor::groupItemsBySection() {
    auto items = m_configManager->getItemsForCategory(m_categoryId);
